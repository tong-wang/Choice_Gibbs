setwd("~/Dropbox/RCode/Choice_Gibbs.git/src/K90Lambda100")
...
ggplot(data=lam) + geom_density(aes(x=lam0), color="black") + 
    ...
    geom_density(aes(x=lam3mh), color="blue") +
...
ggplot(data=lam) + geom_density(aes(x=lam0), color="black") + 
    ...
    geom_density(aes(x=lam3rxh), color="blue")
...
ggplot(data=beta) + geom_density(aes(x=beta0.1), color="black") +
    ...
    geom_density(aes(x=beta3mh.1), color="blue") +
...
ggplot(data=beta) + geom_density(aes(x=beta0.2), color="black") +
    ...
    geom_density(aes(x=beta3mh.2), color="blue") +
