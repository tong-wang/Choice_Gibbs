...
setwd("~/Dropbox/RCode/Choice_Gibbs.git/src/M2.L1/output/K90L50")

load("MNL.M2.L1_Scenario0.RData")
load("MNL.M2.L1_Scenario1.RData")
load("MNL.M2.L1_Scenario3M.xl.RData")
load("MNL.M2.L1_Scenario3M.l.RData")
load("MNL.M2.L1_Scenario3M.m.RData")
load("MNL.M2.L1_Scenario3M.h.RData")
load("MNL.M2.L1_Scenario3M.xh.RData")
