setwd("~/Dropbox/RCode/Choice_Gibbs.git/src/binary.L1/output/K90L50Beta0.1")
...
load("MNL_Scenario3_M.binary.L1.RData")
load("MNL_Scenario3_M.binary.L1.1.RData")
load("MNL_Scenario3_M.binary.L1.2.RData")
load("MNL_Scenario3_M.binary.L1.3.RData")
load("MNL_Scenario3_M.binary.L1.h.RData")

load("MNL_Scenario3_M.binary.L1.1h.RData")
load("MNL_Scenario3_M.binary.L1.2h.RData")
load("MNL_Scenario3_M.binary.L1.3h.RData")
...
plot(beta$beta3ml, type="l")
plot(beta$beta3m, type="l")
plot(beta$beta3m1, type="l")
plot(beta$beta3m2, type="l")
plot(beta$beta3m3, type="l")
plot(beta$beta3mh, type="l")
plot(beta$beta3m1h, type="l")
plot(beta$beta3m2h, type="l")
plot(beta$beta3m3h, type="l")
plot(beta$beta3mxh, type="l")


ggplot(data=beta) + geom_density(aes(x=beta0), color="black") +
    geom_density(aes(x=beta1), color="grey") +
    geom_density(aes(x=beta3ml), color="red") +
    geom_density(aes(x=beta3m), color="green") +
    geom_density(aes(x=beta3m1), color="green") +
    geom_density(aes(x=beta3m2), color="green") +
    geom_density(aes(x=beta3m3), color="green") +
    geom_density(aes(x=beta3mh), color="yellow") +
    geom_density(aes(x=beta3m1h), color="red") +
    geom_density(aes(x=beta3m2h), color="green") +
    geom_density(aes(x=beta3m3h), color="blue") +
    geom_density(aes(x=beta3mxh), color="purple")
